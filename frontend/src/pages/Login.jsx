    ...
    <div className="flex">
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-4 md:p-12 bg-emerald-100">
            ...
            >
                ...
                <p className='text-center mt-4 text-gray-600 text-sm'>
                    ...
                    <Link to={`/register?redirect=${encodeURIComponent(redirect)}`} className='text-emerald-900 font-semibold hover:underline'> Sign up</Link>
                </p>
            </form>
        </div>
        ...
        <div className="hidden md:block w-1/2 bg-emerald-800">
            <div className="h-full flex flex-col justify-center items-center">
                <img src={login} alt="Login to account" className='h-[600px] w-full object-cover' />
            </div>
        </div>
    </div>
  )
